        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-secondary-foreground/80">
              <li><Link href="/news" className="hover:text-primary transition-colors">Aktualności</Link></li>
              <li><Link href="/results" className="hover:text-primary transition-colors">Wyniki</Link></li>
              <li><Link href="/standings" className="hover:text-primary transition-colors">Tabela</Link></li>
              <li><Link href="/team" className="hover:text-primary transition-colors">Drużyna</Link></li>
